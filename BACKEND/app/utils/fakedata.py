...
def generate_fake_data(num_records=1000, output_file='app/models/fake_transactions.csv'):
    data = []
    ...
    print(f"Fake dataset generated successfully and saved to {output_file}.")
